###Para executar: bash setup.sh
##O "bash" provavelmente não funcionará pra no Windows
##Para contornar isso, execute esse comando no
##diretório que está esse arquivo com Git Bash
